...
const Reviews = () => {
    return (
        <div className="bg-[#C5AC80] h-screen mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="flex justify-center  items-center space-x-6">
                        ...
                        <div className='relative'>
                            <div className="bg-white  shadow-lg p-6 w-[324px] flex flex-col items-center space-y-3 rounded-lg">
                                ...
                                <p className="text-gray-600">
                                    Phasellus vitae lorem porta elit molestie vestibulum. Duis varius urna vitae libero dignissim fermentum. Nullam quis purus id sem cursus facilisis.
                                </p>
                                <div className='flex justify-between items-center w-[250px]'>
                                    ...
                                    <div>
                                        <p>4.0 <span className='text-xs text-gray-500'>/5</span></p>
                                    </div>
                        ...
                        {/* Card 2 */}
                        <div className='relative'>
                            <div className="bg-[#1E1E1E] text-white shadow-lg p-6 w-[324px] flex flex-col items-center space-y-3 rounded-lg">
                        ...
                        {/* Card 3 */}
                        <div className='relative'>
                            <div className=" text-black bg-white shadow-lg p-6 w-[324px] flex flex-col items-center space-y-3 rounded-lg">
                                <div className='w-[182px] border-[#A4906C] h-[182px] border-2 rounded-full flex justify-center items-center'>
                                    <img
