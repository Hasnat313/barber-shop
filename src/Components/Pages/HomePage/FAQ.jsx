...
const faqs = [
    ...
    {
        question: "Quisque luctus pulvinar aliquet. Sed vehicula ligula ut nibh aliquam, nec euismod.",
        answer:
            "Etiam cursus massa at elit tempor, non consectetur enim molestie. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae.",
    },
    ...
    {
        question: "Nulla elementum porta neque, vitae egestas lectus aliquam a. Pellentesque gravida.",
        answer:
            "Etiam cursus massa at elit tempor, non consectetur enim molestie. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae.",
    },
];
        ...
        <div className="relative">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, index) => (
                            <div className={` ${isOpen[index] && ("bg-[#C5AC80]")} border-2 rounded-lg p-6 border-[#C5AC80]`} key={index}>
                                <buttonn
                                    type="button"
                                ...
                                >
                                    ...
                                    <svg
                                        className={`h-6 w-6 transform transition-transform ${isOpen[index] && "rotate-180"
                                            }`}
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="absolute bottom-0 right-0">
                                            <svg width="101" height="101" viewBox="0 0 101 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect opacity="0.1" x="50.5095" y="-4" width="77.0881" height="77.0881" rx="10" transform="rotate(45 50.5095 -4)" fill="white" />
                                            </svg>
                                        </div>

                                        <div className="absolute -bottom-[10px] right-20">
                                            <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect opacity="0.1" x="24.2549" y="-1.49023" width="37.1298" height="37.1298" rx="5" transform="rotate(45 24.2549 -1.49023)" fill="white" />
                                            </svg>
            ...
            <div className="absolute top-40 right-10">
                <svg width="199" height="199" viewBox="0 0 199 199" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect opacity="0.1" x="99.4905" y="-8.58579" width="152.843" height="152.843" rx="25" transform="rotate(45 99.4905 -8.58579)" fill="#C5AC80" stroke="#C5AC80" stroke-width="2" />
                </svg>
